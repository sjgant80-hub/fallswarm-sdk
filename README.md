...
**FallSwarm · the collective-identity holder · sovereign · runs in your browser** — sovereign SDK extracted from `fallswarm/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallswarm-sdk
```

## Use
```js
import * as fallswarm from '@ai-native-solutions/fallswarm-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallswarm-sdk/
- MCP wrapper: [`@ai-native-solutions/fallswarm-mcp`](https://github.com/sjgant80-hub/fallswarm-mcp)
- HTTP API: [`@ai-native-solutions/fallswarm-api`](https://github.com/sjgant80-hub/fallswarm-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallswarm-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallswarm-sdk -- npx -y @ai-native-solutions/fallswarm-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallswarm-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallswarm-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallswarm-sdk/
- **Source**: https://github.com/sjgant80-hub/fallswarm-sdk
